...
/// <reference path="src/de/mayflower/mfg/game/MfgCamera.ts" />
/// <reference path="src/de/mayflower/mfg/game/level/MfgLevel.ts" />
/// <reference path="src/de/mayflower/mfg/game/level/MfgLevelBunny.ts" />
/// <reference path="src/de/mayflower/mfg/game/level/MfgLevelFirstPerson.ts" />
/// <reference path="src/de/mayflower/mfg/g3d/MfgMaterial.ts" />
/// <reference path="src/de/mayflower/mfg/g3d/MfgScene.ts" />
/// <reference path="src/de/mayflower/mfg/g3d/MfgSceneFactory.ts" />
/// <reference path="src/de/mayflower/mfg/g3d/MfgSprite.ts" />
